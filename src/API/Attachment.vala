public class Tootle.API.Attachment : Entity, Widgetizable {
	...
	public string? explicit_preview_url { get; set; }
	public string? preview_url {
		set { this.explicit_preview_url = value; }
		get { return (this.explicit_preview_url == null || this.explicit_preview_url == "") ? url : explicit_preview_url; }
	}
